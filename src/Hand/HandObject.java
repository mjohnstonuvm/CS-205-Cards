public class HandObject {
	...
	private static class Hand {
		...
		public Hand (Card card1, Card card2, Card card13, Card card4 ) {
			this.cards[0] = card1;
			this.cards[1] = card2;
			this.cards[2] = card3;
			this.cards[3] = card4;
		...
		//allows you to peek at a card NOTE: index is offset by 1
        ...
        System.out.println("The total is " + a.total());
